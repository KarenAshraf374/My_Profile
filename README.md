...
Computer Science graduate with hands-on experience in developing full-stack web applications using Angular and ASP.NET Core. Skilled in building responsive frontend interfaces and scalable backend RESTful APIs. Strong understanding of software architecture, including MVC patterns and client-server communication. Passionate about writing clean, maintainable code and continuously improving development practices. Eager to contribute to collaborative teams and deliver efficient, high-quality software solutions.
